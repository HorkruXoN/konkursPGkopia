...
<template>
  <div class="home">
    ...
    <div id="banerInfo">
      <div><input type="button" value="Czaty" @click="showChats()" id="czaty" v-if="!show"></div>
    </div>
    <div style="clear: both;"></div>
    <div v-if="error">{{ error }}</div>
    <div v-else id="ChatList" v-if='show'>
      <ChatList :chats="resp" :key="key" @showMessages="showMessages()"/>
    </div>
    <AllMessages :id_chat="id_chat" :key="id_chat" @refresh="refresh" v-if="showMess"/>
